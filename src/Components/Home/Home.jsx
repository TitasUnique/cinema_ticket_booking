  ...
  return (
    ...
    >
      <div style={{ marginLeft: "10px", marginRight: "10px" , borderRadius: "10px" }}>
        <img src="https://assetscdn1.paytm.com/images/catalog/view_item/2699893/1719426863191.jpg?format=webp&imwidth=1750" />
      </div>
      <div style={{ marginLeft: "10px", marginRight: "10px" , borderRadius: "10px" }}>
        <img src="https://assets-in.bmscdn.com/promotions/cms/creatives/1720784019967_freeaccesswebws.jpg" />
      </div>
      <div style={{ marginLeft: "10px", marginRight: "10px" , borderRadius: "10px" }}>
